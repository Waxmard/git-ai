<!-- Generated from docs/src/test-CLAUDE.md by scripts/build_docs.py. Run `make docs-build` to regenerate. Do not edit directly. -->

# CLAUDE.md — `test/`

Guidance for Claude Code (claude.ai/code) when working under `test/`. The repo-wide guide is the root `CLAUDE.md`.
